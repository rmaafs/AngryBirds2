...
public class Level5 implements Level {
    ...
    public void generate(Stage stage, World world) {
        for (int i = 0; i < 5; i++) {
            materiales.add(new MaterialCreator(MaterialType.WOOD, BoxType.STICK, stage, world, new Vector2(27, floor + i * 2)));
        }

        for (int i = 0; i < 10; i++) {
            materiales.add(new MaterialCreator(MaterialType.STONE, BoxType.STICK, stage, world, new Vector2(40, floor + i * 2)));
        }
    ...
    public void generateEnemys(Stage stage, World world) {
        ...
        enemigos.add(new EnemyCreator(EnemyType.CASCO, stage, world, new Vector2(35, floor + 2)));
    }
